#!/home/elvin/anaconda3/envs/tensorflow/bin/python3
    ...
    for dataset_idx, dataset in enumerate(datasets):
        ...
        #    continue
            ...
            for offset_name, offset in offsets:
                ...
                print('{}-{}.npy is split into {} blocks.'.format(datetime.now(), dataset, blocks.shape[0]))
                ...
                for block_idx in range(idx_last_non_empty_block + 1):
                    ...
                    for block_split_idx in range(block_split_num):
                        ...
                        if ((idx + 1) % batch_size == 0) or \
                            ...
                            filename_h5 = os.path.join(root, dataset+'_%s_%d.h5' % (offset_name, idx_h5))
                            ...
                            if args.save_ply:
                                ...
                                filepath_label_ply = os.path.join(folder, dataset+'_ply_label',
                                ...
                                filepath_rgb_ply = os.path.join(folder, dataset+'_ply_rgb',
